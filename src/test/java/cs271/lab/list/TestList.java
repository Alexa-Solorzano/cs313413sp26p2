...
public class TestList {
  ...
  public void testSizeNonEmpty() {
    // FIXED: TODO fix the expected values in the assertions below
    list.add(77);
  ...
  public void testAddAll() {
    // FIXED: TODO in a single statement using addAll and List.of,
  ...
  public void testRemoveAll() {
    ...
    list.add(77);
    list.add(66);
    // FIXED: TODO in a single statement using removeAll and List.of,
  ...
  public void testSet() {
    ...
    // List went from: 33,77,44,77,55,77,66
    //             to: 33,99,44,99,55,99,66
    // 3 changes were made: 1) Index 1 went from 77 to 99 2) Index 3 went from 77 to 99 3) Index 5 went from 77 to 99
    list.set(1,99);
    list.set(3,99);
    list.set(5,99);
    assertEquals(7, list.size());
