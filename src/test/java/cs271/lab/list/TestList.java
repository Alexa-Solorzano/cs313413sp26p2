...
public class TestList {
  ...
  public void testSizeNonEmpty() {
    // FIXING: TODO fix the expected values in the assertions below
    list.add(77);
  ...
  public void testAddAll() {
    // FIXING: TODO in a single statement using addAll and List.of,
  ...
  public void testRemoveAll() {
    ...
    list.add(77);
    list.add(66);
    // FIXING: TODO in a single statement using removeAll and List.of,
